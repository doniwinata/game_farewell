    ...
    <body>
        ...
        <div class="container">
            ...
            <ul class="list-unstyled video-list-thumbs row">
                ...
                $data[] = "buta huruf";
                $data[] = "minum tolak angin";
                $data[] = "musim dingin";

                $data[] = "bangun pondasi";
                $data[] = "jual laptop baru";
                $data[] = "buang ingus";
                $data[] = "serangan jantung ringan";
                $data[] = "aku sayang mama papa";
                $data[] = "main hape";
                $data[] = "terlalu manis";
                $data[] = "kerja sampai larut malam";
                $data[] = "cari pacar";
                $data[] = "lempar bola tangan";
                $data[] = "makan telur mata sapi";
                $data[] = "patah hati";
                $data[] = "masak paha ayam";
