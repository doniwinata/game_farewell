    ...
    <body>
        ...
        <div class="container">
            ...
            <ul class="list-unstyled video-list-thumbs row">
                ...
                $data[] = "mobil mobilan ketua partai";
                $data[] = "anjing tetangga tuang kopi";
                $data[] = "ingat mantan";

                $data[] = "gendang telinga";
                $data[] = "pacaran jarak jauh";
                $data[] = "belajar bahasa inggris";
                $data[] = "bangun siang";
                $data[] = "kontak jodoh";
                $data[] = "isu miring";
                $data[] = "kena tilang polisi";
                $data[] = "kamar tidur";
                $data[] = "korban php";
                $data[] = "petani indonesia kirim uang";
                $data[] = "umpan silang";
                $data[] = "malu sama kucing";
                $data[] = "cewek tapi laki";
